...
**Travis Build** [![Travis Build Status](https://travis-ci.org/greengage-db/gpdb.svg?branch=main)](https://travis-ci.org/greengage-db/gpdb) |

----------------------------------------------------------------------

![Greengage](logo-greengage.png)
...
* __gpdb-doc/__
  ...
  Contains the Greengage documentation in DITA XML format. Refer to
...
so, please fill out and submit the [Contributor License Agreement](https://cla.pivotal.io/sign/greengage).
