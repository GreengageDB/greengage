...
/* GPDB: exposed (non-static) because guc_gp.c references it */
...
const char *const config_group_names[] =
{
	...
	[EXTERNAL_TABLES] = gettext_noop("External Tables"),
	[APPENDONLY_TABLES] = gettext_noop("Append-Only Tables"),
	[RESOURCES] = gettext_noop("Resource Usage"),
	...
	[LOGGING] = gettext_noop("Reporting and Logging"),
	...
	[STATS] = gettext_noop("Statistics"),
	[STATS_ANALYZE] = gettext_noop("Statistics / Analyze"),
	...
	[CLIENT_CONN] = gettext_noop("Client Connection Defaults"),
	...
	[COMPAT_OPTIONS] = gettext_noop("Version and Platform Compatibility"),
	...
	[COMPAT_OPTIONS_IGNORED] = gettext_noop("Version and Platform Compatibility / Ignored"),
	[ERROR_HANDLING_OPTIONS] = gettext_noop("Error Handling"),
	[GP_ARRAY_CONFIGURATION] = gettext_noop(PACKAGE_NAME " / Array Configuration"),
	[GP_ARRAY_TUNING] = gettext_noop(PACKAGE_NAME " / Array Tuning"),
	[GP_WORKER_IDENTITY] = gettext_noop(PACKAGE_NAME " / Worker Process Identity"),
	[GP_ERROR_HANDLING] = gettext_noop("GPDB Error Handling"),
	...
	[DEPRECATED_OPTIONS] = gettext_noop("Deprecated Options"),
	[DEFUNCT_OPTIONS] = gettext_noop("Defunct Options"),
	/* help_config wants this array to be null-terminated */
	NULL
};

StaticAssertDecl(lengthof(config_group_names) == (DEFUNCT_OPTIONS + 2),
				 "array length mismatch");
