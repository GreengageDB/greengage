...
test__MemoryAccounting_GetAccountName__Validate(void **state)
{
	...
	char* shortLivingNames[] = {"Top", "Main", "Parser", "Planner", "PlannerHook", "Dispatcher", "Serializer", "Deserializer",
			...
			"X_BitmapHeapScan", "X_DynamicBitmapHeapScan",
			"X_TidScan", "X_SubqueryScan", "X_FunctionScan", "X_TableFunctionScan",
			...
			"X_AssertOp", "X_PartitionSelector", "X_RecursiveUnion", "X_CteScan", "X_WorkTableScan", "X_ForeignScan", "X_NestedExecutor"};
