...
/*
 * GPDB: hand-written equal support for nodes marked custom_copy_equal whose
 * fields gen_node_support.pl cannot emit (Datum/bytea).  Kept in sync with the
 * merged struct definitions.
 */
...
_equalColumnDef(const ColumnDef *a, const ColumnDef *b)
{
	...
	/* ignore cooked missingval (hasCookedMissingVal/missingVal/missingIsNull) */
	...
	/* GPDB: encoding intentionally not compared (open GPDB_90_MERGE_FIXME) */
