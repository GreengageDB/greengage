...
%token <keyword> ABORT_P ABSENT ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	EACH ELSE EMPTY_P ENABLE_P ENCODING ENCRYPTED END_P ENDPOINT ENFORCED ENUM_P
	ERROR_P ESCAPE EVENT EXCEPT EXCLUDE EXCLUDING EXCLUSIVE EXECUTE EXISTS EXPLAIN
	...
	MERGE MERGE_ACTION METHOD MINUTE_P MINVALUE MODE MONTH_P MOVE
...
%token <keyword>
	...
	SCATTER SEGMENT SEGMENTS SUBPARTITION
...
alter_table_cmd:
			...
			/* ALTER TABLE <name> SET ACCESS METHOD { <amname> | DEFAULT } WITH (<reloptions>) */
