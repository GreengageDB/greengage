...
CStringTest::EresUnittest_Append()
{
	...
	GPOS_UNITTEST_ASSERT(ss1.Equals("123456"));
	...
	GPOS_UNITTEST_ASSERT(ss3.Equals("123456"));

	// check truncation
	ss3.Append(&ss2);
	GPOS_UNITTEST_ASSERT(ss3.Equals("1234564"));

	// test wide character string
	ss1.Reset();
	ss1.AppendConvert(GPOS_WSZ_LIT("Wide \x1111 character string"));
	GPOS_UNITTEST_ASSERT(ss1.Equals("Wide . characte"));
...
CStringTest::EresUnittest_AppendFormat()
{
	...
	GPOS_UNITTEST_ASSERT(ss1.Equals("Hello world 123"));
	GPOS_UNITTEST_ASSERT(ss2.Equals("Hello world"));
...
CStringTest::EresUnittest_Equals()
{
	...
	GPOS_UNITTEST_ASSERT(ss1.Equals(ss2.Buffer()));
	GPOS_UNITTEST_ASSERT(!ss1.Equals(ss3.Buffer()));
	GPOS_UNITTEST_ASSERT(!ss3.Equals(ss1.Buffer()));
