...
#define GPDB_GP_PERCENTILE_DISC \
	OID(7194)  // gp_percentile_disc (col,fraction,cnt)
#define GPDB_GP_PERCENTILE_CONT_FLOAT8 \
	OID(7189)  // gp_percentile_cont(col,fraction,cnt)
#define GPDB_GP_PERCENTILE_CONT_INTERVAL \
	OID(7190)  // gp_percentile_cont(col,fraction,cnt)
#define GPDB_GP_PERCENTILE_CONT_TIMESTAMP \
	OID(7191)  // gp_percentile_cont(col,fraction,cnt)
#define GPDB_GP_PERCENTILE_CONT_TIMESTAMPTZ \
	OID(7192)  // gp_percentile_cont(col,fraction,cnt)
