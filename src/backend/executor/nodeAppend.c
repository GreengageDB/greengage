...
ExecInitAppend(Append *node, EState *estate, int eflags)
{
	...
	else
	{
		...
		/*
		 * GPDB: if join pruning is possible, leave the valid subplans
		 * unidentified so that choose_next_subplan_* calls
		 * ExecFindMatchingSubPlans, which performs the join pruning.
		 */
