				   ...
				   Datum *resultVal, bool *resultIsNull)
{
	...
	/*
	 * GPDB: If result is pass-by-ref, make sure it is in the right context.
	 * (Upstream removed this safety net along with MemoryContextContains in
	 * PG16; GGDB keeps it, using the MemTuple-aware Generic variant.)
	 */
