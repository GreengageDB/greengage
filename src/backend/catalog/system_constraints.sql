...
ALTER TABLE pg_resqueue ADD UNIQUE USING INDEX pg_resqueue_oid_index;

ALTER TABLE pg_resqueue ADD UNIQUE USING INDEX pg_resqueue_rsqname_index;

ALTER TABLE pg_resourcetype ADD UNIQUE USING INDEX pg_resourcetype_oid_index;

ALTER TABLE pg_resourcetype ADD UNIQUE USING INDEX pg_resourcetype_restypid_index;

ALTER TABLE pg_resourcetype ADD UNIQUE USING INDEX pg_resourcetype_resname_index;

ALTER TABLE pg_resgroup ADD UNIQUE USING INDEX pg_resgroup_oid_index;

ALTER TABLE pg_resgroup ADD UNIQUE USING INDEX pg_resgroup_rsgname_index;

ALTER TABLE pg_resgroupcapability ADD UNIQUE USING INDEX pg_resgroupcapability_resgroupid_reslimittype_index;

ALTER TABLE gp_distribution_policy ADD UNIQUE USING INDEX gp_distribution_policy_localoid_index;

ALTER TABLE gp_segment_configuration ADD UNIQUE USING INDEX gp_segment_config_content_preferred_role_index;

ALTER TABLE gp_segment_configuration ADD UNIQUE USING INDEX gp_segment_config_dbid_index;

ALTER TABLE pg_appendonly ADD UNIQUE USING INDEX pg_appendonly_relid_index;

ALTER TABLE gp_fastsequence ADD UNIQUE USING INDEX gp_fastsequence_objid_objmod_index;

ALTER TABLE pg_extprotocol ADD UNIQUE USING INDEX pg_extprotocol_oid_index;

ALTER TABLE pg_extprotocol ADD UNIQUE USING INDEX pg_extprotocol_ptcname_index;

ALTER TABLE pg_attribute_encoding ADD UNIQUE USING INDEX pg_attribute_encoding_attrelid_attnum_index;

ALTER TABLE pg_compression ADD UNIQUE USING INDEX pg_compression_compname_index;

ALTER TABLE pg_proc_callback ADD UNIQUE USING INDEX pg_proc_callback_profnoid_promethod_index;

ALTER TABLE pg_type_encoding ADD UNIQUE USING INDEX pg_type_encoding_typid_index;

ALTER TABLE pg_stat_last_operation ADD UNIQUE USING INDEX pg_statlastop_classid_objid_staactionname_index;

ALTER TABLE pg_stat_last_shoperation ADD UNIQUE USING INDEX pg_statlastshop_classid_objid_staactionname_index;
...
ALTER TABLE gp_partition_template ADD UNIQUE USING INDEX gp_partition_template_relid_level_index;
