...
static const SysFKRelationship sys_fk_relationships[] = {
	...
	{ /* pg_compression */ 7056, /* pg_proc */ 1255, "{compconstructor}", "{oid}", false, false},
	{ /* pg_compression */ 7056, /* pg_proc */ 1255, "{compdestructor}", "{oid}", false, false},
	{ /* pg_compression */ 7056, /* pg_proc */ 1255, "{compcompressor}", "{oid}", false, false},
	{ /* pg_compression */ 7056, /* pg_proc */ 1255, "{compdecompressor}", "{oid}", false, false},
	{ /* pg_compression */ 7056, /* pg_proc */ 1255, "{compvalidator}", "{oid}", false, false},
	...
	{ /* pg_publication */ 6107, /* pg_authid */ 1260, "{pubowner}", "{oid}", false, false},
	{ /* pg_publication_namespace */ 6237, /* pg_publication */ 6107, "{pnpubid}", "{oid}", false, false},
	{ /* pg_publication_namespace */ 6237, /* pg_namespace */ 2615, "{pnnspid}", "{oid}", false, false},
	{ /* pg_publication_rel */ 6106, /* pg_publication */ 6107, "{prpubid}", "{oid}", false, false},
