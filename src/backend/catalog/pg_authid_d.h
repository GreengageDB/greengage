...
#define Anum_pg_authid_rolresqueue 13
#define Anum_pg_authid_rolcreaterextgpfd 14
#define Anum_pg_authid_rolcreaterexthttp 15
#define Anum_pg_authid_rolcreatewextgpfd 16
