									...
									MultiXactId *minmulti)
{
	...
	*minmulti = GetOldestMultiXactId();
	...
	srel = RelationCreateStorage(*newrlocator, persistence, SMGR_MD, true);
...
heapam_relation_copy_data(Relation rel, const RelFileLocator *newrlocator)
{
	...
	dstrel = smgropen(*newrlocator, rel->rd_backend, SMGR_MD);
	 ...
	 */
	RelationCreateStorage(*newrlocator, rel->rd_rel->relpersistence, SMGR_MD, true);
