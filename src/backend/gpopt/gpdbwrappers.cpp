...
gpdb::IsFuncAllowedForPartitionSelection(Oid funcid)
{
	...
	switch (funcid)
	{
		...
		case F_FLOAT8_INT4:		// int4(float8) -> int4
		case F_FLOAT4_INT4:		// int4(float4) -> int4
		case F_INT8_INT2:		// int2(int8) -> int2
		case F_INT8_INT4:		// int4(int8) -> int4
		case F_INT4_INT2:		// int2(int4) -> int2
		case F_FLOAT4_INT8:		// int8(float4) -> int8
		case F_FLOAT4_INT2:		// int2(float4) -> int2
		case F_FLOAT4_NUMERIC:	// numeric(float4) -> numeric
		case F_FLOAT8_INT8:		// int8(float8) -> int8
		case F_FLOAT8_FLOAT4:	// float4(float8) -> float4
