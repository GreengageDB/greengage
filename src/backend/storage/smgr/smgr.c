...
const f_smgr *
smgr_standard(BackendId backend, RelFileLocator rlocator, SMgrImpl which)
{
	// for md.c
	return &smgrsw[which];
}
...
const f_smgr *
smgr(BackendId backend, RelFileLocator rlocator, SMgrImpl which)
{
	const f_smgr *result;
 ...
 */
SMgrRelation
smgropen(RelFileLocator rlocator, BackendId backend, SMgrImpl which)
{
