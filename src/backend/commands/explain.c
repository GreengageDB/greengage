			 ...
			 ParamListInfo params, DestReceiver *dest)
{
	...
	/*
	 * GPDB: EXPLAIN memory-detail output is driven by the
	 * explain_memory_verbosity GUC rather than by an EXPLAIN option.
	 */
						 ...
						 QueryEnvironment *queryEnv)
{
	...
	ExplainOnePlan(plan, into, es, queryString, params, queryEnv,
				   ...
				   es->memory ? &mem_counters : NULL, cursorOptions);
}
...
/*
 * GPDB: Explain a property whose value is built from a printf-style format
 * string.  Used e.g. for the "Optimizer" line.
 */
static void
