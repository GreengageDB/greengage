...
#endif /* GPDB: NextCopyFromRawFields is in copy.c using CopyState */

/*
 * GPDB: NextCopyFromRawFieldsInternal must stay compiled in this file: it is
 * the pg_attribute_always_inline workhorse inlined into CopyFromTextLikeOneRow
 * below.  Only the public wrappers (NextCopyFromRawFields/NextCopyFrom) live in
 * copy.c, so this internal helper is deliberately outside the #if 0 blocks.
 *
...
#if 0 /* GPDB: NextCopyFrom is in copy.c using CopyState */
/*
