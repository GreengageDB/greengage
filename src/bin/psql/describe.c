				  ...
				  bool verbose, bool showSystem)
{
	...
	printQueryOpt myopt = pset.popt;
	/*
	 * GPDB adds two translatable verbose columns after "Type": "Data access"
	 * and "Execute on".  Graft those onto the upstream flags (Type, Volatility,
	 * Parallel, Security and -- new in PG18 -- Leakproof? are translated).
	 */
	static const bool translate_columns[] = {false, false, false, false, true, true, true, true, true, false, true, true, false, false, false, false};

	/* No "Parallel" column before 9.6 */
	static const bool translate_columns_pre_96[] = {false, false, false, false, true, true, true, true, false, true, true, false, false, false, false};
