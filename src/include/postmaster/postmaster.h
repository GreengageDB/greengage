...
#include "lib/ilist.h"
#include "miscadmin.h"
#include "libpq/pqcomm.h"		/* for MsgType (GPDB cancel/finish request) */
...
extern void processCancelRequest(int backendPID, int32 cancelAuthCode, MsgType code);
...
/* GPDB: number of postmaster-managed auxiliary bgworkers (see PMAuxProcList) */
