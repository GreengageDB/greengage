...
DECLARE_UNIQUE_INDEX(pg_proc_callback_profnoid_promethod_index, 9926, ProcCallbackProfnoidPromethodIndexId, pg_proc_callback, btree(profnoid oid_ops, promethod char_ops));
