...
DECLARE_INDEX(pg_statlastshop_classid_objid_index, 6057, StatLastShOpClassidObjidIndexId, pg_stat_last_shoperation, btree(classid oid_ops, objid oid_ops));
DECLARE_UNIQUE_INDEX(pg_statlastshop_classid_objid_staactionname_index, 6058, StatLastShOpClassidObjidStaactionnameIndexId, pg_stat_last_shoperation, btree(classid oid_ops, objid oid_ops, staactionname name_ops));
