...
/* GPDB-specific EXPLAIN helpers (no home in the new explain_* split headers) */
extern void ExplainPrintExecStatsEnd(struct ExplainState *es, QueryDesc *queryDesc);

extern void cdbexplain_printJITSummary(struct ExplainState *es, QueryDesc *queryDesc);
