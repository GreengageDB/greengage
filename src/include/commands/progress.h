...
/* Phases of vacumm for Greengage AO/AOCO tables */
#define PROGRESS_VACUUM_PHASE_AO_PRE_CLEANUP	7
#define PROGRESS_VACUUM_PHASE_AO_COMPACT		8
#define PROGRESS_VACUUM_PHASE_AO_POST_CLEANUP	9
...
/* Phases of cluster for Greengage AO/AOCO tables */
#define PROGRESS_CLUSTER_PHASE_SEQ_SCAN_AO		8
#define PROGRESS_CLUSTER_PHASE_WRITE_NEW_AO		9
