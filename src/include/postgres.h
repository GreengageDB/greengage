 ...
 *
 * GPDB: this conversion does not exist in upstream PostgreSQL.
 */
static inline int8
...
/*
 * IsAligned
 *		GPDB: test whether a pointer is aligned on the given power-of-2
 *		boundary (used by the AO datumstream code).
 */
static inline bool
IsAligned(void *p, int align)
{
