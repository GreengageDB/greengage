 ...
 */
/*
 * GPDB: refcount is narrowed to 17 bits (vs upstream 18) and the flag region
 * widened to 11 bits so that the extra GPDB-only BM_TEMP flag (bit 21) fits.
 */
#define BUF_REFCOUNT_BITS 17
