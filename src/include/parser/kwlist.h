...
PG_KEYWORD("am", AM, UNRESERVED_KEYWORD)				/* GPDB */
...
PG_KEYWORD("cpu_max_percent", CPU_MAX_PERCENT, UNRESERVED_KEYWORD)
PG_KEYWORD("cpu_weight", CPU_WEIGHT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("rebalance", REBALANCE, UNRESERVED_KEYWORD)      /* GPDB */
...
PG_KEYWORD("relopt", RELOPT, UNRESERVED_KEYWORD)			/* GPDB */
PG_KEYWORD("rename", RENAME, UNRESERVED_KEYWORD)
PG_KEYWORD("repack", REPACK, UNRESERVED_KEYWORD)			/* GPDB */
