...
PG_KEYWORD("active", ACTIVE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("concurrency", CONCURRENCY, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("contains", CONTAINS, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("coordinator", COORDINATOR, UNRESERVED_KEYWORD, AS_LABEL)      /* GPDB */
PG_KEYWORD("copy", COPY, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("cost", COST, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("cpu_rate_limit", CPU_RATE_LIMIT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("cpuset", CPUSET, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("create", CREATE, RESERVED_KEYWORD, AS_LABEL)
PG_KEYWORD("createexttable", CREATEEXTTABLE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("decode", DECODE, RESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("deny", DENY, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("distributed", DISTRIBUTED, RESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("dxl", DXL, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("endpoint", ENDPOINT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("enum", ENUM_P, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("errors", ERRORS, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("escape", ESCAPE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("event", EVENT, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("every", EVERY, UNRESERVED_KEYWORD, AS_LABEL)          /* Reserved in standard */
PG_KEYWORD("except", EXCEPT, RESERVED_KEYWORD, AS_LABEL)
PG_KEYWORD("exchange", EXCHANGE, UNRESERVED_KEYWORD, BARE_LABEL)    /* GPDB */
PG_KEYWORD("exclude", EXCLUDE, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("expand", EXPAND, UNRESERVED_KEYWORD, AS_LABEL) /* GPDB */
...
PG_KEYWORD("fields", FIELDS, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("fill", FILL, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("following", FOLLOWING, RESERVED_KEYWORD, BARE_LABEL)      /* Unreserved in standard */
...
PG_KEYWORD("fullscan", FULLSCAN, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("group_id", GROUP_ID, COL_NAME_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("hash", HASH, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("host", HOST, UNRESERVED_KEYWORD, BARE_LABEL)              /* GPDB */
...
PG_KEYWORD("initplan", INITPLAN, UNRESERVED_KEYWORD, AS_LABEL)      /* GPDB */
...
PG_KEYWORD("list", LIST, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("listen", LISTEN, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("load", LOAD, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("local", LOCAL, UNRESERVED_KEYWORD, BARE_LABEL)        /* Reserved in standard */
...
PG_KEYWORD("log", LOG_P, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("logged", LOGGED, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("mapping", MAPPING, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("master", MASTER, UNRESERVED_KEYWORD, BARE_LABEL)      /* GPDB */
...
PG_KEYWORD("median", MEDIAN, COL_NAME_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("memory_limit", MEMORY_LIMIT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("memory_shared_quota", MEMORY_SHARED_QUOTA, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("memory_spill_ratio", MEMORY_SPILL_RATIO, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("method", METHOD, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("minute", MINUTE_P, UNRESERVED_KEYWORD, AS_LABEL)
PG_KEYWORD("minvalue", MINVALUE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("missing", MISSING, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("mode", MODE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("modifies", MODIFIES, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("newline", NEWLINE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("nocreateexttable", NOCREATEEXTTABLE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("none", NONE, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("noovercommit", NOOVERCOMMIT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("ordered", ORDERED, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("overcommit", OVERCOMMIT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("partition", PARTITION, RESERVED_KEYWORD, AS_LABEL)         /* GPDB */
PG_KEYWORD("partitions", PARTITIONS, UNRESERVED_KEYWORD, BARE_LABEL)     /* GPDB */
PG_KEYWORD("passing", PASSING, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("password", PASSWORD, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("percent", PERCENT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("persistently", PERSISTENTLY, UNRESERVED_KEYWORD, BARE_LABEL) /* GPDB */
PG_KEYWORD("placing", PLACING, RESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("plans", PLANS, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("policy", POLICY, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("position", POSITION, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("preceding", PRECEDING, RESERVED_KEYWORD, BARE_LABEL)         /* unreserved in standard */
...
PG_KEYWORD("protocol", PROTOCOL, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("publication", PUBLICATION, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("queue", QUEUE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("quote", QUOTE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("randomly", RANDOMLY, UNRESERVED_KEYWORD, BARE_LABEL)        /* GPDB */
PG_KEYWORD("range", RANGE, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("read", READ, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("readable", READABLE, UNRESERVED_KEYWORD, BARE_LABEL)        /* GPDB */
PG_KEYWORD("reads", READS, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("reject", REJECT_P, UNRESERVED_KEYWORD, BARE_LABEL)          /* GPDB */
...
PG_KEYWORD("replicated", REPLICATED, UNRESERVED_KEYWORD, AS_LABEL) /* GPDB */
PG_KEYWORD("reset", RESET, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("resource", RESOURCE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("restart", RESTART, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("restrict", RESTRICT, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("retrieve", RETRIEVE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("rootpartition", ROOTPARTITION, UNRESERVED_KEYWORD, AS_LABEL)		/* GPDB */
...
PG_KEYWORD("scatter", SCATTER, RESERVED_KEYWORD, AS_LABEL)           /* GPDB */
...
PG_KEYWORD("segment", SEGMENT, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
PG_KEYWORD("segments", SEGMENTS, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("split", SPLIT, UNRESERVED_KEYWORD, BARE_LABEL)             /* GPDB */
...
PG_KEYWORD("subpartition", SUBPARTITION, UNRESERVED_KEYWORD, BARE_LABEL)    /* GPDB */
...
PG_KEYWORD("threshold", THRESHOLD, UNRESERVED_KEYWORD, BARE_LABEL)          /* GPDB */
...
PG_KEYWORD("unbounded", UNBOUNDED, RESERVED_KEYWORD, BARE_LABEL)			/* Unreserved in standard */
...
PG_KEYWORD("validation", VALIDATION, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("web", WEB, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
...
PG_KEYWORD("writable", WRITABLE, UNRESERVED_KEYWORD, BARE_LABEL)		/* GPDB */
