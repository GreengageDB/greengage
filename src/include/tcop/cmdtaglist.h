...
PG_CMDTAG(CMDTAG_DECLARE_PARALLEL_RETRIEVE_CURSOR, "DECLARE PARALLEL RETRIEVE CURSOR", false, false, false)
...
PG_CMDTAG(CMDTAG_ALTER_RESOURCE_GROUP, "ALTER RESOURCE GROUP", false, false, false)
PG_CMDTAG(CMDTAG_CREATE_EXTERNAL_TABLE, "CREATE EXTERNAL TABLE", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_RESOURCE_GROUP, "CREATE RESOURCE GROUP", false, false, false)
PG_CMDTAG(CMDTAG_DROP_PROTOCOL, "DROP PROTOCOL", true, false, false)
PG_CMDTAG(CMDTAG_DROP_QUEUE, "DROP QUEUE", false, false, false)
PG_CMDTAG(CMDTAG_DROP_RESOURCE_GROUP, "DROP RESOURCE GROUP", false, false, false)
PG_CMDTAG(CMDTAG_FAULT, "fault", false, false, false)
PG_CMDTAG(CMDTAG_FTS_PROBE, "PROBE", false, false, false)
PG_CMDTAG(CMDTAG_FTS_PROMOTE, "PROMOTE", false, false, false)
PG_CMDTAG(CMDTAG_FTS_SYNCREP_OFF, "SYNCREP_OFF", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_ABORT_NO_PREPARED, "Distributed Abort (No Prepared)", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_ABORT_PREPARED, "Distributed Abort Prepared", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_ABORT_SOME_PREPARED, "Distributed Abort (Some Prepared)", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_COMMIT_ONEPHASE, "Distributed Commit (one-phase)", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_COMMIT_PREPARED, "Distributed Commit Prepared", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_NONE, "None", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_PREPARE, "Distributed Prepare", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_RECOVERY_ABORT_PREPARED, "Recovery Abort Prepared", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_RECOVERY_COMMIT_PREPARED, "Recovery Commit Prepared", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_RETRY_ABORT_PREPARED, "Retry Distributed Abort Prepared", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_RETRY_COMMIT_PREPARED, "Retry Distributed Commit Prepared", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_SUBTRANSACTION_BEGIN_INTERNAL, " Begin Internal Subtransaction", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_SUBTRANSACTION_RELEASE_INTERNAL, "Release Current Subtransaction", false, false, false)
PG_CMDTAG(CMDTAG_MPPDTX_COMMAND_SUBTRANSACTION_ROLLBACK_INTERNAL, "Rollback Current Subtransaction", false, false, false)
...
PG_CMDTAG(CMDTAG_MPPEXEC_UTILITY, "MPPEXEC UTILITY", false, false, false)
PG_CMDTAG(CMDTAG_RETRIEVE, "RETRIEVE", false, false, false)
