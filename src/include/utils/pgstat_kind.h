...
/* GPDB: per-resource-queue statistics (variable-numbered, keyed by queue OID) */
#define PGSTAT_KIND_RESQUEUE	13

#define PGSTAT_KIND_BUILTIN_MIN PGSTAT_KIND_DATABASE
#define PGSTAT_KIND_BUILTIN_MAX PGSTAT_KIND_RESQUEUE
