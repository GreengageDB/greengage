...
/* SQL statements */
FI_DDL_STATEMENT(MPPExecUtility, "MPPEXEC UTILITY")
FI_DDL_STATEMENT(MPPExecSelect, "MPPEXEC SELECT")
FI_DDL_STATEMENT(MPPExecInsert, "MPPEXEC INSERT")
FI_DDL_STATEMENT(MPPExecUpdate, "MPPEXEC UPDATE")
FI_DDL_STATEMENT(MPPExecDelete, "MPPEXEC DELETE")
FI_DDL_STATEMENT(Release, "RELEASE")
FI_DDL_STATEMENT(Rollback, "ROLLBACK")
FI_DDL_STATEMENT(SavePoint, "SAVEPOINT")
/* dtx protocol operation */
FI_DDL_STATEMENT(AbortNoPrepared, "abort_no_prepared")
FI_DDL_STATEMENT(Prepare, "prepare")
FI_DDL_STATEMENT(AbortSomePrepared, "abort_some_prepared")
FI_DDL_STATEMENT(CommitOnePhase, "commit_onephase")
FI_DDL_STATEMENT(CommitPrepared, "commit_prepared")
FI_DDL_STATEMENT(AbortPrepared, "abort_prepared")
FI_DDL_STATEMENT(RetryCommitPrepared, "retry_commit_prepared")
FI_DDL_STATEMENT(RetryAbortPrepared, "retry_abort_prepared")
FI_DDL_STATEMENT(RecoveryCommitPrepared, "recovery_commit_prepared")
FI_DDL_STATEMENT(RecoveryAbortPrepared, "recovery_abort_prepared")
FI_DDL_STATEMENT(SubtransactionBegin, "subtransaction_begin")
FI_DDL_STATEMENT(SubtransactionRelease, "subtransaction_release")
FI_DDL_STATEMENT(SubtransactionRollback, "subtransaction_rollback")
#endif
