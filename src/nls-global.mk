...
ifdef XGETTEXT
XGETTEXT += -ctranslator --copyright-holder='Greengage Projec' --msgid-bugs-address=bugs@greengagedb.org --no-wrap --sort-by-file --package-name='$(CATALOG_NAME) (Greengage)' --package-version='$(MAJORVERSION)'
endif
