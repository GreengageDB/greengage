...
INSERT INTO TEMP_INT2 (f1)
  SELECT int2(f1) FROM FLOAT8_NUMER_TBL
  WHERE (f1 >= -32767) AND (f1 <= 32767);

INSERT INTO TEMP_INT2 (f1)
  SELECT int2(f1) FROM INT4_NUMER_TBL
  WHERE (f1 >= -32767) AND (f1 <= 32767);
...
-- Clean up the GPDB-added tables
DROP TABLE FLOAT8_NUMER_TBL;
DROP TABLE INT2_NUMER_TBL;
DROP TABLE INT4_NUMER_TBL;
