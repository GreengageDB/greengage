...
\! PGOPTIONS='-c gp_session_role=utility' psql -p 7002 -d regression -c 'UPDATE t_test SET a = 1 WHERE a = 2;'
\! PGOPTIONS='-c gp_session_role=utility' psql -p 7002 -d regression -c 'SELECT * FROM t_test ORDER BY 1;'
DROP TABLE t_test;
