...
-- PG17 JSON_TABLE: a non-lateral table function in FROM is an RTE_TABLEFUNC,
-- which ORCA does not translate.  It must fall back cleanly; in a production
-- (non-cassert) build this used to reach __builtin_unreachable() in
