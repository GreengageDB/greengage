...
-- GGDB: the time-travel trigger example (ttdummy) is used by the triggers test;
-- PostgreSQL dropped it from the core test suite, but Greengage keeps the
-- coverage, so re-create the C function here (it lives in regress.c again).
