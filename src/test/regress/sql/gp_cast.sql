...
drop table if exists cst_varchar;
...
create table cst_float4 as (select a::float4 from generate_series(5, 15, 1) as a) distributed by (a);
create table cst_float8 as (select a::float8 from generate_series(5, 15, 1) as a) distributed by (a);
