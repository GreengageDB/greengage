...
-- GGDB_14_MERGE_FIXME: We don't support parallel query. These tests won't actually
...
insert into names6 select * from names order by last_name returning *; -- order none
...
insert into names7 select * from names order by last_name returning last_name || ', ' || first_name as last_name_then_first_name; -- order none
...
-- Disable trigger tests to avoid errors
-- start_ignore
/*
--
