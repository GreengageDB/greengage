...
TestLib::append_to_file("$pgdata/${baseUnloggedPath}_vm",  'TEST_VM');
TestLib::append_to_file("$pgdata/${baseUnloggedPath}_fsm", 'TEST_FSM');
...
TestLib::append_to_file("$pgdata/${ts1UnloggedPath}_vm",  'TEST_VM');
TestLib::append_to_file("$pgdata/${ts1UnloggedPath}_fsm", 'TEST_FSM');
