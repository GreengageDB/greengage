...
1: select gp_inject_fault_infinite('tuplestore_freeze', 'suspend', 2);
...
-- end_ignore
2: select gp_wait_until_triggered_fault('tuplestore_freeze', 1, 2);
2: select gp_inject_fault_infinite('tuplestore_freeze', 'resume', 2);
2: select gp_inject_fault_infinite('tuplestore_freeze', 'reset', 2);
2q:
1<:
1q:
