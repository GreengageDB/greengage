...
2&: reindex index reindex_crtab_part_ao_btree_1_prt_de_fault_id_idx;
...
select count(*) from reindex_crtab_part_ao_btree where id = 998;
set enable_seqscan=false;
set enable_indexscan=true;
select count(*) from reindex_crtab_part_ao_btree where id = 999;
