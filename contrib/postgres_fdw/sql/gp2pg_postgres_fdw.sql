-- This file is based on postgres_fdw.sql. 
-- Compared with postgres_fdw.sql, there are such changes as follows.
-- 1. Using postgres_fdw, gpdb connects to remote postgres server. This file is run in gpdb.
-- 2. Some features are not supported in gpdb, so related test cases is disabled.
--    The features no supported in gpdb are as follows.
--    2.1 gpdb don't support that ModifyTable mixes distributed and entry-only tables.
--    2.2 gpdb don't support triggers for statements.
...
CREATE USER MAPPING FOR CURRENT_USER SERVER pgserver2;
...
ALTER SERVER pgserver OPTIONS (SET dbname 'no such database');
SELECT c3, c4 FROM ft1 ORDER BY c3, c1 LIMIT 1;  -- should fail
DO $d$
    BEGIN
        EXECUTE $$ALTER SERVER pgserver
...
ALTER USER MAPPING FOR CURRENT_USER SERVER pgserver
...
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT t1."C 1" FROM "S 1"."T 1" t1 left join ft1 t2 join ft2 t3 on (t2.c1 = t3.c1) on (t3.c1 = t1."C 1") order by t1."C 1" OFFSET 100 LIMIT 10;
SELECT t1."C 1" FROM "S 1"."T 1" t1 left join ft1 t2 join ft2 t3 on (t2.c1 = t3.c1) on (t3.c1 = t1."C 1") order by t1."C 1" OFFSET 100 LIMIT 10;
-- Test similar to above, except that the full join prevents any equivalence
-- classes from being merged. This produces single relation equivalence classes
-- included in join restrictions.
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT t1."C 1", t2.c1, t3.c1 FROM "S 1"."T 1" t1 left join ft1 t2 full join ft2 t3 on (t2.c1 = t3.c1) on (t3.c1 = t1."C 1") order by t1."C 1" OFFSET 100 LIMIT 10;
SELECT t1."C 1", t2.c1, t3.c1 FROM "S 1"."T 1" t1 left join ft1 t2 full join ft2 t3 on (t2.c1 = t3.c1) on (t3.c1 = t1."C 1") order by t1."C 1" OFFSET 100 LIMIT 10;
-- Test similar to above with all full outer joins
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT t1."C 1", t2.c1, t3.c1 FROM "S 1"."T 1" t1 full join ft1 t2 full join ft2 t3 on (t2.c1 = t3.c1) on (t3.c1 = t1."C 1") order by t1."C 1" OFFSET 100 LIMIT 10;
SELECT t1."C 1", t2.c1, t3.c1 FROM "S 1"."T 1" t1 full join ft1 t2 full join ft2 t3 on (t2.c1 = t3.c1) on (t3.c1 = t1."C 1") order by t1."C 1" OFFSET 100 LIMIT 10;
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TEXT SEARCH CONFIGURATION public.custom_search (COPY = pg_catalog.english);'
...
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 FULL JOIN ft2 t2 ON (t1.c1 = t2.c1) FULL JOIN ft4 t3 ON (t2.c1 = t3.c1) ORDER BY t1.c1, t2.c2, t3.c3 OFFSET 10 LIMIT 10;
-- full outer join + right outer join
EXPLAIN (VERBOSE, COSTS OFF)
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 FULL JOIN ft2 t2 ON (t1.c1 = t2.c1) RIGHT JOIN ft4 t3 ON (t2.c1 = t3.c1) OFFSET 10 LIMIT 10;
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 FULL JOIN ft2 t2 ON (t1.c1 = t2.c1) RIGHT JOIN ft4 t3 ON (t2.c1 = t3.c1) ORDER BY t1.c1, t2.c2, t3.c3 OFFSET 10 LIMIT 10;
-- right outer join + full outer join
EXPLAIN (VERBOSE, COSTS OFF)
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 RIGHT JOIN ft2 t2 ON (t1.c1 = t2.c1) FULL JOIN ft4 t3 ON (t2.c1 = t3.c1) OFFSET 10 LIMIT 10;
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 RIGHT JOIN ft2 t2 ON (t1.c1 = t2.c1) FULL JOIN ft4 t3 ON (t2.c1 = t3.c1) ORDER BY t1.c1, t2.c2, t3.c3 OFFSET 10 LIMIT 10;
-- full outer join + left outer join
EXPLAIN (VERBOSE, COSTS OFF)
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 FULL JOIN ft2 t2 ON (t1.c1 = t2.c1) LEFT JOIN ft4 t3 ON (t2.c1 = t3.c1) OFFSET 10 LIMIT 10;
SELECT t1.c1, t2.c2, t3.c3 FROM ft2 t1 FULL JOIN ft2 t2 ON (t1.c1 = t2.c1) LEFT JOIN ft4 t3 ON (t2.c1 = t3.c1) ORDER BY t1.c1, t2.c2, t3.c3 OFFSET 10 LIMIT 10;
...
ANALYZE local_tbl;
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE local_tbl (c1 int NOT NULL, c2 int NOT NULL, c3 text, CONSTRAINT local_tbl_pkey PRIMARY KEY (c1));'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c "INSERT INTO local_tbl SELECT id, id % 10, to_char(id, 'FM0000') FROM generate_series(1, 1000) id;"
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ANALYZE local_tbl;'
SET enable_nestloop TO false;
SET enable_hashjoin TO false;
SET enable_mergejoin TO true;
EXPLAIN (VERBOSE, COSTS OFF)
...
RESET enable_hashjoin;
RESET enable_mergejoin;
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'DROP TABLE local_tbl;'
DROP TABLE local_tbl;

-- check join pushdown in situations where multiple userids are involved
CREATE ROLE regress_view_owner SUPERUSER;
CREATE USER MAPPING FOR regress_view_owner SERVER pgserver;
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TRIGGER t1_br_insert BEFORE INSERT OR UPDATE ON "S 1"."T 1" FOR EACH ROW EXECUTE PROCEDURE "S 1".F_BRTRIG();'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE FUNCTION row_before_insupd_trigfunc() RETURNS trigger AS $$BEGIN NEW.a := NEW.a + 10; RETURN NEW; END$$ LANGUAGE plpgsql;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE base_tbl (a int, b int);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE base_tbl SET (autovacuum_enabled = 'false');'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TRIGGER row_before_insupd_trigger BEFORE INSERT OR UPDATE ON base_tbl FOR EACH ROW EXECUTE PROCEDURE row_before_insupd_trigfunc();'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'DROP TRIGGER row_before_insupd_trigger ON base_tbl;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'DROP TABLE base_tbl;'
-- DROP TRIGGER row_before_insupd_trigger ON base_tbl;
-- DROP TABLE base_tbl;

-- test WCO for partitions
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE child_tbl (a int, b int);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE child_tbl SET (autovacuum_enabled = 'false');'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TRIGGER row_before_insupd_trigger BEFORE INSERT OR UPDATE ON child_tbl FOR EACH ROW EXECUTE PROCEDURE row_before_insupd_trigfunc();'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'DROP TABLE child_tbl;'
-- DROP TRIGGER row_before_insupd_trigger ON child_tbl;
DROP TABLE parent_tbl CASCADE;

\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'DROP FUNCTION row_before_insupd_trigfunc;'
-- DROP FUNCTION row_before_insupd_trigfunc;

-- ===================================================================
-- test serial columns (ie, sequence-based defaults)
-- ===================================================================
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loc1 (f1 serial, f2 text);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'alter table loc1 set (autovacuum_enabled = 'false');'
...
-- ===================================================================
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table gloc1 (a int, b int generated always as (a * 2) stored);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'alter table gloc1 set (autovacuum_enabled = 'false');'
-- create table gloc1 (
--   a int,
...
DROP TRIGGER trig_row_before ON rem1;
DROP TRIGGER trig_row_after ON rem1;
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c  'DROP TRIGGER trig_local_before ON loc1;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'DROP TABLE loct;'
-- DROP TABLE loct;

-- Check SELECT FOR UPDATE/SHARE with an inherited source table
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loct1 (f1 int, f2 int, f3 int);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loct2 (f1 int, f2 int, f3 int);'
create table loct1 (f1 int, f2 int, f3 int);
create table loct2 (f1 int, f2 int, f3 int);

\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'alter table loct1 set (autovacuum_enabled = 'false');'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'truncate table loct1;'
truncate table loct1;
truncate table only foo;
-- \! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c "$\set num_rows_foo 2000"
-- \! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c "insert into loct1 select generate_series(0, :num_rows_foo, 2), generate_series(0, :num_rows_foo, 2), generate_series(0, :num_rows_foo, 2);"
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c "insert into loct1 select generate_series(0, 2000, 2), generate_series(0, 2000, 2), generate_series(0, 2000, 2);"
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create index i_loct1_f1 on loct1(f1);'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop table loct1;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop table loct2;'
drop table loct1;
drop table loct2;

-- Test pushing down UPDATE/DELETE joins to the remote server
create table parent (a int, b text);
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loct1 (a int, b text);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loct2 (a int, b text);'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'delete from loct2;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create unique index loct1_idx on loct1 (a);'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop index loct1_idx;'
...
-- end
-- $$ language plpgsql;
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create trigger loct1_br_insert_trigger before insert on loct1 for each row execute procedure br_insert_trigfunc();'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create trigger loct2_br_insert_trigger before insert on loct2 for each row execute procedure br_insert_trigfunc();'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop trigger loct1_br_insert_trigger on loct1;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop trigger loct2_br_insert_trigger on loct2;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loct (a int check (a in (1)), b text);'
-- create table loct (a int check (a in (1)), b text);
create foreign table remp (a int check (a in (1)), b text) server pgserver options (table_name 'loct');
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create trigger loct_br_insert_trigger before insert on loct for each row execute procedure br_insert_trigfunc();'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop trigger loct_br_insert_trigger on loct;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'alter table loct drop constraint loct_a_check;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'alter table loct add check (a in (3));'
-- alter table loct drop constraint loct_a_check;
-- alter table loct add check (a in (3));
create foreign table remp (a int check (a in (3)), b text) server pgserver options (table_name 'loct');
...
-- test COPY FROM
-- ===================================================================
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create table loc2 (f1 int, f2 text);'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'alter table loc2 drop constraint loc2_f1positive;'
...
\.
select * from rem2;
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop trigger trig_row_before_insert on loc2;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop trigger trig_null on loc2;'
...
create trigger rem2_trig_row_after after insert on rem2
	for each row execute procedure trigger_data(23,'skidoo');
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'create trigger loc2_trig_row_before_insert before insert on loc2 for each row execute procedure trig_row_before_insupdate();'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop trigger loc2_trig_row_before_insert on loc2;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'drop table loc3;'
-- drop table loc3;

-- ===================================================================
-- test IMPORT FOREIGN SCHEMA
-- ===================================================================
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE SCHEMA import_source;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source.t1 (c1 int, c2 varchar NOT NULL);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source.t2 (c1 int default 42, c2 varchar NULL, c3 text collate "POSIX");'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TYPE typ1 AS (m1 int, m2 varchar);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source.t3 (c1 timestamptz default now(), c2 typ1);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source."x 4" (c1 float8, "C 2" text, c3 varchar(42));'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source."x 5" (c1 float8);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE import_source."x 5" DROP COLUMN c1;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source."x 6" (c1 int, c2 int generated always as (c1 * 2) stored);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source.t4 (c1 int) PARTITION BY RANGE (c1);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source.t4_part PARTITION OF import_source.t4 FOR VALUES FROM (1) TO (100);'
...
IMPORT FOREIGN SCHEMA import_source FROM SERVER pgserver INTO import_dest4;
IMPORT FOREIGN SCHEMA nonesuch FROM SERVER pgserver INTO import_dest4;
IMPORT FOREIGN SCHEMA nonesuch FROM SERVER pgserver INTO notthere;
IMPORT FOREIGN SCHEMA nonesuch FROM SERVER nowhere INTO notthere;

-- Check case of a type present only on the remote server.
-- We can fake this by dropping the type locally in our transaction.
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TYPE "Colors" AS ENUM ($$red$$, $$green$$, $$blue$$);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE import_source.t5 (c1 int, c2 text collate "C", "Col" "Colors");'
...
IMPORT FOREIGN SCHEMA import_source LIMIT TO (t5)
  FROM SERVER pgserver INTO import_dest5;  -- ERROR
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE fprt1 (a int, b int, c varchar) PARTITION BY RANGE(a);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE fprt1_p1 (LIKE fprt1);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE fprt1_p2 (LIKE fprt1);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE fprt1_p1 SET (autovacuum_enabled = 'false');'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE fprt1_p2 SET (autovacuum_enabled = 'false');'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO fprt1_p1 SELECT i, i, to_char(i/50, $$FM0000$$) FROM generate_series(0, 249, 2) i;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO fprt1_p2 SELECT i, i, to_char(i/50, $$FM0000$$) FROM generate_series(250, 499, 2) i;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE fprt2 (a int, b int, c varchar) PARTITION BY RANGE(b);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE fprt2_p1 (LIKE fprt2);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE fprt2_p2 (LIKE fprt2);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE fprt2_p1 SET (autovacuum_enabled = 'false');'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'ALTER TABLE fprt2_p2 SET (autovacuum_enabled = 'false');'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO fprt2_p1 SELECT i, i, to_char(i/50, $$FM0000$$) FROM generate_series(0, 249, 3) i;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO fprt2_p2 SELECT i, i, to_char(i/50, $$FM0000$$) FROM generate_series(250, 499, 3) i;'
...
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE pagg_tab (a int, b int, c text) PARTITION BY RANGE(a);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE pagg_tab_p1 (LIKE pagg_tab);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE pagg_tab_p2 (LIKE pagg_tab);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'CREATE TABLE pagg_tab_p3 (LIKE pagg_tab);'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO pagg_tab_p1 SELECT i % 30, i % 50, to_char(i/30, $$FM0000$$) FROM generate_series(1, 3000) i WHERE (i % 30) < 10;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO pagg_tab_p2 SELECT i % 30, i % 50, to_char(i/30, $$FM0000$$) FROM generate_series(1, 3000) i WHERE (i % 30) < 20 and (i % 30) >= 10;'
\! env PGOPTIONS='' psql -p ${PG_PORT} contrib_regression -c 'INSERT INTO pagg_tab_p3 SELECT i % 30, i % 50, to_char(i/30, $$FM0000$$) FROM generate_series(1, 3000) i WHERE (i % 30) < 30 and (i % 30) >= 20;'
