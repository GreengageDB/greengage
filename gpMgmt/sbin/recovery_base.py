...
class RecoveryBase(object):
    ...
    def parseargs(self):
        ...
        parser.add_option(
            "-v", "--verbose", action="store_true", help="debug output.", default=False
        )
            ...
            if not item.get_results().wasSuccessful():
                ...
                try:
                    ...
                    error_obj = recoveryinfo.RecoveryError(
                        recoveryinfo.RecoveryErrorType.DEFAULT_ERROR,
                        err_str,
                        None,
                        None,
                        None,
    ...
    def run_and_set_output(recovery_cmd):
        try:
            ...
            serialized_error = str(
                recoveryinfo.RecoveryError(
                    recovery_cmd.error_type,
                    str(e),
            ...
            recovery_cmd.set_results(
                CommandResult(1, b"", serialized_error.encode(), True, False)
            )
        else:
