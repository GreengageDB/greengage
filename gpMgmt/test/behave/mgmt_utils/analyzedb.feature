...
Feature: Incrementally analyze the database
    ...
    Scenario: Missing parameters
        ...
        Then analyzedb should print "error: -d option requires (an|1) argument" error message
        When the user runs "analyzedb -d incr_analyze -t"
        Then analyzedb should print "error: -t option requires (an|1) argument" error message
        When the user runs "analyzedb -d incr_analyze -s"
        Then analyzedb should print "error: -s option requires (an|1) argument" error message
        When the user runs "analyzedb -d incr_analyze -t public.t1_ao -i"
        Then analyzedb should print "error: -i option requires (an|1) argument" error message
        When the user runs "analyzedb -d incr_analyze -t public.t1_ao -x"
        Then analyzedb should print "error: -x option requires (an|1) argument" error message
