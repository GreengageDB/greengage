...
Feature: gpinitsystem tests
	...
	Given create demo cluster config
        ...
        When the user runs command "source $GPHOME/greengage_path.sh; __DCA_VERSION_FILE__=/tmp/gpinitsystem/gpdb-appliance-version $GPHOME/bin/gpinitsystem -a -c ../gpAux/gpdemo/clusterConfigFile"
        Then gpinitsystem should return a return code of 0
