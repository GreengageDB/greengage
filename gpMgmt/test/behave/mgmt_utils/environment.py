...
def before_scenario(context, scenario):
    ...
    if "concourse_cluster" in scenario.effective_tags and "demo_cluster" not in scenario.effective_tags and not context.config.tag_expression.check(["concourse_cluster"]):
