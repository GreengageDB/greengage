...
from .TEST_local_base import prepare_before_test
...
def test_312_gpload_yaml_with_error_limit_2_not_reached():
    ...
    write_config_file(
        format="text", file="data_file.txt", table="texttable", error_limit=2
    )
...
def test_313_gpload_yaml_with_error_limit_2_reached():
    ...
    copy_data("external_file_312.txt", "data_file.txt")
    write_config_file(
        format="text", file="data_file.txt", table="texttable", error_limit=3
    )
...
def test_352_gpload_yaml_force_not_null_is_false():
    ...
    copy_data("external_file_351.csv", "data_file.csv")
    write_config_file(
        format="csv", file="data_file.csv", table="csvtable", delimiter="','"
    )
