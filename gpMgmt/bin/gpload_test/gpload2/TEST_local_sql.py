...
def test_661_gpload_sql_after_success():
    ...
    write_config_file(
        ...
        table="texttable_661",
        sql=True,
        after="INSERT INTO test_661 VALUES(1)",
    )
...
def test_663_gpload_sql_before_after():
    ...
    write_config_file(
        ...
        table="texttable_663",
        sql=True,
        before="INSERT INTO test_663_before VALUES(1)",
        after="INSERT INTO test_663_after VALUES(2)",
    )
...
def test_664_gpload_sql_before_after():
    ...
    write_config_file(
        ...
        table="texttable_664",
        sql=True,
        before="INSERT INTO test_664_before VALUES('a')",
        after="INSERT INTO test_664_after VALUES(2)",
    )
...
def test_666_gpload_sql_before_after():
    ...
    write_config_file(
        ...
        table="texttable_666",
        sql=True,
        before="INSERT INTO test_666_before VALUES('a')",
        after="INSERT INTO test_666_after VALUES(2)",
    )
...
def test_667_gpload_sql_before_after():
    ...
    write_config_file(
        ...
        table="texttable_667",
        sql=True,
        before="INSERT INTO test_667_before VALUES(1)",
        after="INSERT INTO test_667_after VALUES('a')",
    )
