...
from .TEST_local_base import copy_data, run, hostNameAddrs, masterPort
import pytest
...
def test_44_gpload_config_h():
    ...
    write_config_file(
        host="", format="text", file="data_file.txt", table="texttable", delimiter="'|'"
    )
...
def test_48_gpload_config_d():
    ...
    copy_data("external_file_01.txt", "data_file.txt")
    write_config_file(
        database="", format="text", file="data_file.txt", table="texttable"
    )
...
def test_55_gpload_yaml_version():
    ...
    copy_data("external_file_01.txt", "data_file.txt")
    write_config_file(
        version="1.0.0.2", format="text", file="data_file.txt", table="texttable"
    )
...
def test_56_gpload_yaml_wrong_database():
    ...
    copy_data("external_file_01.txt", "data_file.txt")
    write_config_file(
        database="notexist", format="text", file="data_file.txt", table="texttable"
    )
...
def test_57_gpload_yaml_wrong_user():
    ...
    copy_data("external_file_01.txt", "data_file.txt")
    write_config_file(
        user="notexist", format="text", file="data_file.txt", table="texttable"
    )
...
def test_59_gpload_yaml_wrong_port():
    ...
    copy_data("external_file_01.txt", "data_file.txt")
    write_config_file(
        port="111111", format="text", file="data_file.txt", table="texttable"
    )
...
def test_61_gpload_local_no_port():
    ...
    copy_data("external_file_01.txt", "data_file.txt")
    write_config_file(
        input_port=None, format="text", file="data_file.txt", table="texttable"
    )
...
def test_100_gpload_transform():
    runfile(mkpath("setup.sql"))
    write_config_file(
        file="data/transform/prices.xml",
