...
class InitStandbyTestCase(unittest.TestCase):
    @patch(
        "gppylib.operations.initstandby.unix.InterfaceAddrs.remote",
        return_value=["192.168.2.1", "192.168.1.1"],
    )
    ...
    @patch(
        "gppylib.operations.initstandby.get_standby_pg_hba_info",
        return_value="standby ip",
    )
