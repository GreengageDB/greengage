...
class GetTablespaceDirTestCase(GpTestCase):
    def setUp(self):
        ...
        self.apply_patches([
            ...
            patch(
                "gppylib.operations.segment_tablespace_locations.dbconn.execSQL",
                self.mock_query,
            ),
            patch(
                "gppylib.operations.segment_tablespace_locations.logger",
    ...
    def test_validate_data_with_mirror_data_directory_get_tablespace_locations(self):
        ...
        self.assertEqual(
            expected, get_tablespace_locations(False, mirror_data_directory)
        )
    ...
    def test_get_segment_tablespace_oid_locations_exception(self, mock1):
        ...
        self.assertTrue(
            "Failed to get segment tablespace locations for segment with host sdw1 and port 40000"
            in str(ex.exception)
        )
    ...
    def test_get_segment_tablespace_oid_locations_success(self, mock1, mock2, mock3):
        ...
        self.assertEqual(
            [
                call(
                    "Successfully got tablespace locations for segment with host sdw1, port 40000"
                )
            ],
