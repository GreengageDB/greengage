...
class GpCommandTestCase(GpTestCase):
    ...
    @patch('gppylib.commands.gp.Command.run')
    @patch('gppylib.commands.gp.Command.get_results', return_value=CommandResult(0, b"gpadmin  1234     1  0 18:48 ?        00:00:00 /usr/local/greengage-db-devel/bin/postgres -D /tmp -p", b"", True, False))
