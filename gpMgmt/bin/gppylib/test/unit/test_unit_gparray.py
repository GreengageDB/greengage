...
#------------------------------- non-test helpers --------------------------------
    ...
    @patch('gppylib.db.dbconn.querySingleton', return_value='PostgreSQL 8.3.23 (Greengage Database 5.0.0 build dev) on x86_64-pc-linux-gnu, compiled by GCC gcc (GCC) 4.4.7 20120313 (Red Hat 4.4.7-17) compiled on Feb  9 2017 23:06:31')
