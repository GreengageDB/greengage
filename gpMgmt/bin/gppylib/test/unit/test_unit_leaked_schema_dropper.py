...
class LeakedSchemaDropperTestCase(GpTestCase):
    ...
    def test_drop_leaked_schemas__returns_a_list_of_leaked_schemas(self):
        self.assertEqual(
            ...
            ["fake_leak_1", 'some"test"special_#;character--schema'],
        )

    def test_drop_leaked_schemas__when_there_are_no_leaked_schemas__returns_an_empty_list(
        self,
    ):
    ...
    def test_drop_leaked_schemas__when_query_returns_null_schema__returns_an_empty_list(
        self,
    ):
    ...
    def test_drop_leaked_schemas__drops_orphaned_and_leaked_schemas(self):
        ...
        drop_query_expected_list = [
            call('DROP SCHEMA IF EXISTS "fake_leak_1" CASCADE;'),
            call(
                'DROP SCHEMA IF EXISTS "some""test""special_#;character--schema" CASCADE;'
            ),
        ]
